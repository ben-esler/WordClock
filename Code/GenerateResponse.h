String generateResponse(String lastAction = ""){
  ...
  response += "    <h3>Brightness Controls</h3>\n"
              ...
              "        <input name='brightness_min' type='range' min='1' max='757' step='1' value='" + (String)brightnessMin + "' oninput='this.parentNode.dataset.lbound=this.value;'/>\n"
              "        <input name='brightness_max' type='range'  min='1' max='757' step='1' value='" + (String)brightnessMax + "' oninput='this.parentNode.dataset.ubound=this.value;'/>\n"
              "      </div>\n"
